...
function PresaleCategoriesView() {
    ...
    const fetchcategoryTokens = async (page: number = 1, pageSize: number = 10) => {
    try {
        setLoading(true);
        const res = await axios.get(`${apiBase}/tokens/presale-subcategory/${subcategoryId}/tokens?page=${page}&pageSize=${pageSize}`);
        if (res.data.error) {
  ...
  return (
    <div className="new-presale-token-container">
      <h2>Upcoming Presales for {subcategoryName || 'All Tokens'}</h2>
                    ...
                    <div className='new-presale-token-status'>
                        <div className='new-presale-token-name-and-age'>
                          ...
                          <div className='new-presale-current-funds-frame'>
                            ...
                            <div className='new-presale-current-funds'>{token?.presaleSol? token?.presaleSol : 0}</div>
                          </div>
                        </div>
...
export default PresaleCategoriesView