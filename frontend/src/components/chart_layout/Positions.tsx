...
import DepositYield from '../dashboard_components/DepositYield';
...
function Positions() {
  ...
  return (
    <div className="flex flex-col">
      {/* <span>{formatTinyUSD(Number(pnlDollar.toFixed(8)))}</span> */}
          ...
          <table>
            <thead>
              <tr>
                ...
                <th title="Close the Position">Close</th>
                    ...
                    <div className="chart-dashboard-image-wrapper">
                      {position?.tokenImage ? (
                        <img
                          ...
                          className="chart-dashboard-token-img"
                        />
                      ) : (
                        '—'
                      )}
                      <img
                        src={logo_overlay}
                        alt="MemeLend logo"
                        className="chart-dashboard-overlay-img"
                      />
                    </div>
                  </td>
                  <td>
