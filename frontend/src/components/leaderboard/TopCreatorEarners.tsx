  ...
  const apiBase = import.meta.env.VITE_API_URL || 'http://localhost:3001';
    ...
    const fetchNewTokens = async (page: number = 1, pageSize: number = 50) => {
        try {
          ...
          const res = await axios.get(`${apiBase}/leaderboard/top-creator?page=${page}&pageSize=${pageSize}`);
          if (res.data.error) {
...
export default TopCreatorEarners