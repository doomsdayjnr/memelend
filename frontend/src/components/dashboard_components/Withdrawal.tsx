...
function Withdrawal({ mint, position_id}: { 
  ...
  const { connection } = useConnection();
    ...
    const handleWithdrawal = async () => {
      ...
      try {
        ...
        const res = await axios.post(`${apiBase}/yield/claim-yield-token`, {
  ...
  return (
    <div>
      <button onClick={handleWithdrawal} disabled={loading} className={loading ? 'loading-button' : 'dashboard-atn-btn'}>
