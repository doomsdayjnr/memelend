...
function ClaimPresaleFees({ mint}: { 
  mint: string | undefined;
    ...
    const handleEarningsClaim = async () => {
        ...
        const res = await axios.post(`${apiBase}/reward/claim-presale-earnings`, {
  ...
  return (
    <div>
        <button onClick={handleEarningsClaim} disabled={loading} className={loading ? 'loading-button' : 'dashboard-atn-btn'}>
...
export default ClaimPresaleFees