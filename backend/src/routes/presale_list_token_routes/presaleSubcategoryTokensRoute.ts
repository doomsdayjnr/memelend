...
const presaleSubcategoryTokensRoute: FastifyPluginAsync = async (server) => {
  server.get('/presale-subcategory/:id/tokens', async (req, reply) => {
...
export default presaleSubcategoryTokensRoute;
